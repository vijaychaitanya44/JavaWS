...
public class ReadPayloadFromJson {

	public static void main(String[] args) throws IOException {
	
		String placeJson = new String(Files.readAllBytes(Paths.get("D:\\Eclipse WS\\Interview_Prep\\RestApiFramework\\src\\test\\resources\\AddPlace.json")));
